...
class Plc():
    ...
    def Connection(self, AMSNETID):
        #Connection à l Ipc (AMSNETID ce trouve sur twincat3)
    ...
    def CreationVariableList(self, NomPRG, NomServoList):
        ...
        # Pour separer les differents variables utiliser sa : Nom_ID, Nom_ModeRotation, Nom_PosMin, Nom_PosMax, Nom_PosInit, Nom_Homing, Nom_HomingONOFF, Nom_HomingBasHaut, Nom_CapteurHoming, Nom_VitesseHoming, Nom_ForceHoming, Nom_MoveRun, Nom_PositionOrdre, Nom_Vitesse, Nom_Syncro, Nom_Force, Nom_PositionReel, Nom_Position0, Nom_HomingDone, Nom_Etat, Nom_CodeErreur, Nom_Movement = Nom_ListVariablesALL
        LongeurList = len(NomServoList)
        Nom_ID, Nom_ModeRotation, Nom_PosMin, Nom_PosMax, Nom_PosInit, Nom_Homing, Nom_HomingONOFF, Nom_HomingBasHaut, Nom_CapteurHoming, Nom_VitesseHoming, Nom_ForceHoming, Nom_PositionApresHoming, Nom_MoveRun, Mom_ModeRun, Nom_Prioritaire, Nom_PositionOrdre, Nom_Vitesse, Nom_Syncro, Nom_Force, Nom_PositionReel, Nom_Position0, Nom_HomingDone, Nom_Etat, Nom_CodeErreur, Nom_Movement, Nom_EnCycle = [],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]
        ...
        for i in range(LongeurList):
            ...
            Mom_ModeRun = Mom_ModeRun + [NomPRG + "." + NomServoList [i] + "." + "iModeRun"]
            Nom_Prioritaire = Nom_Prioritaire + [NomPRG + "." + NomServoList [i] + "." + "bPrioritaire"]
            ...
            Nom_Syncro = Nom_Syncro + [NomPRG + "." + NomServoList [i] + "." + "bSyncroMode"]
    ...
    def AllLitVariables(self, Nom_ListVariables):
        ...
        Nom_ID, Nom_ModeRotation, Nom_PosMin, Nom_PosMax, Nom_PosInit, Nom_Homing, Nom_HomingONOFF, Nom_HomingBasHaut, Nom_CapteurHoming, Nom_VitesseHoming, Nom_ForceHoming, Nom_PositionApresHoming, Nom_MoveRun, Mom_ModeRun, Nom_Prioritaire, Nom_PositionOrdre, Nom_Vitesse, Nom_Syncro, Nom_Force, Nom_PositionReel, Nom_Position0, Nom_HomingDone, Nom_Etat, Nom_CodeErreur, Nom_Movement = Nom_ListVariables
        ...
        Val_ModeRun = self.plc.read_list_by_name(Nom_ModeRun)
        ...
        Val_Syncro = self.plc.read_list_by_name(Nom_Syncro)
        return Val_ID, Val_ModeRotation, Val_PosMin, Val_PosMax, Val_PosInit, Val_Homing, Val_HomingONOFF, Val_HomingBasHaut, Val_CapteurHoming, Val_VitesseHoming, Val_ForceHoming, Nom_PositionApresHoming, Val_MoveRun, Val_ModeRun, Val_Prioritaire, Val_PositionOrdre, Val_Vitesse, Val_Syncro
